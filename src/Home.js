...
function Home() {
  return (
      <header
          data-aos="fade-in"
          className="clip-rabbet mt-12 md:mt-0 md:flex md:items-center md:justify-center md:min-h-[calc(min(1024px,100vh))] md:rounded-t-none md:rounded-bl-[100px] bg-gradient"
      >
        <div className="pt-2.5 z-[40] md:z-auto">
          <div className={'absolute hidden md:block opacity-30 stripe-bg inset-0 z-0'}/>
          <div className={'sm:px-6 md:px-16 relative px-5 md:z-50 py-16 md:py-24'}>
